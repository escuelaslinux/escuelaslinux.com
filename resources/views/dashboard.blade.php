...
<a href="{!! url('user/notifications') !!}"><span class="fa fa-envelope-o"></span> Notifications</a><br>
<a href="{!! url('admin/notifications') !!}"><span class="fa fa-envelope-o"></span> Admin Notifications</a><br>
